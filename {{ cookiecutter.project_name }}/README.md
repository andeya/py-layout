...
[![Python Version](https://img.shields.io/pypi/pyversions/{{ cookiecutter.package_name }}.svg)](https://pypi.org/project/{{ cookiecutter.package_name }}/)
...
{%- if cookiecutter.install_safety %}[![Security: bandit](https://img.shields.io/badge/security-bandit-green.svg)](https://github.com/PyCQA/bandit){% endif %}
...
{% if cookiecutter.project_mode == 'bin' -%}Then you can run the client using the following command:
...
```bibtex
{% raw %}@misc{{% endraw %}{{ cookiecutter.package_name }},
